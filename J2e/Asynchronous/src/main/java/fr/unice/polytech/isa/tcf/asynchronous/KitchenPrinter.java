...
public class KitchenPrinter implements MessageListener {
	 ...
	 * @param message a JMS message that contains an fr.unice.polytech.isa.tcf.entities.Order
	...
	/**
	 * Business logic to process an fr.unice.polytech.isa.tcf.entities.Order (basically sysout)
	 * @param data
	...
	private void handle(Order data) throws IllegalStateException {
		...
		try {
			log.info("fr.unice.polytech.isa.tcf.asynchronous.KitchenPrinter:\n  Printing order #"+d.getId());
	...
	@Resource(name = "fr.unice.polytech.isa.tcf.asynchronous.KitchenPrinterAck") private Queue acknowledgmentQueue;
